...
/**
 * Steepest descent hill climb class that implements greater than or equal.
 */
public class SteepestDescentHC_GE extends SteepestDescentHC{
    /**
     ...
     */
    public SteepestDescentHC_GE(Problem problem, Random random) {
