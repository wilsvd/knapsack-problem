...
/**
 * Davis bit hill climb class that implements strictly greater.
 */
public class DavisBitHC_G extends DavisBitHC{
     ...
     */
    public DavisBitHC_G(Problem problem, Random random) {
